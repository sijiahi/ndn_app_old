...
public:
    ...
    void setupUi(QMainWindow *ndn_app)
    {
        ...
        nfd_Manager = new QPushButton(centralWidget);
        nfd_Manager->setObjectName(QStringLiteral("nfd_Manager"));
        nfd_Manager->setGeometry(QRect(0, 0, 261, 171));
    ...
    void retranslateUi(QMainWindow *ndn_app)
    {
        ...
        nfd_Manager->setText(QApplication::translate("ndn_app", "NFD Report", Q_NULLPTR));
